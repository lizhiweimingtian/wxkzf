...
define('SEND_BY_REGISTER',    4); // 按注册用户发放      代码增加  BY  www.68ecshop.com
...
/*转拨订单状态*/
define('MOVE_ONE', 0);//转拨录入中
define('MOVE_TWO', 1);//待收货人确认
define('MOVE_THREE',2);//转拨成功
define('MOVE_FOUR',3);//拒绝转拨
define('MOVE_FIVE',4);//转拨撤销

/*出入库状态表关联,来自表ecs_store_inout_type中的数值*/
define('INOUT_MOVE_OUT',12);//转拨出库状态
define('INOUT_MOVE_IN',13);//转拨入库状态
define('INOUT_MOVE_OUT_IN',14);//转拨撤销后入库状态
define('INOUT_APPOINT_IN',15);//订单指库入库状态
define('INOUT_APPOINT_OUT',16);//订单指库出库状态

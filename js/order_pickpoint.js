function show(o,sid){ 
	...
	var pid = document.getElementById('point'+sid).value;
	 Ajax.call('flow.php?step=select_pickinfo', 'sid=' + sid + '&pid='+pid, pickinfo, 'GET', 'JSON');
	o.style.display = "";
}
function hide(o){ 
	var o = document.getElementById(o); 
...
function save_point(suppid){
	Ajax.call('flow.php?step=save_point', 'sid=' + suppid + '&pid='+$('#s_pid').val(), selectpickinfo, 'GET', 'JSON');
	hide('pop');
}

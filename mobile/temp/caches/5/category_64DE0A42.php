<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:58:"D:/www/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:68:"D:/www/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:68:"D:/www/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1470828229;s:8:"maketime";i:1470824629;}<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8">
<meta name="format-detection" content="telephone=no">
<meta name="viewport" content="minimal-ui=yes,width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
<title>平板电视_大家电_家用电器_小京东  </title>
...
var url = 'category.php?act=ajax&category=183&&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=&order=';
$(function(){
...
<div class="list_top" >
    ...
    <div id="fenleitanchu" class='zitidian_div' style="display:none">
     <div class="f_bg fenleilist" style="overflow-y:scroll; height:auto">
            <div id="menu0" onClick="javascript:location.href='category.php?category=183&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC'">价格</div>
            <div id="menu1" onClick="javascript:location.href='category.php?category=183&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC'">销量</div>
            <div id="menu2" onClick="javascript:location.href='category.php?category=183&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC'">更新</div>
            <div id="menu3" onClick="javascript:location.href='category.php?category=183&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC'">最新</div>
     </div>
...
<ul><li class="filtrate_list_li"><a href="category.php?id=178" class="filtrate_list_li_a " style="padding-left:25px"><span>大家电</span></a><ul>
 
<li class="filtrate_list_li"><a href="category.php?id=183" class="filtrate_list_li_a on" style="padding-left:45px;">平板电视</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=184" class="filtrate_list_li_a " style="padding-left:45px;">空调冰箱</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=185" class="filtrate_list_li_a " style="padding-left:45px;">洗衣机</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=186" class="filtrate_list_li_a " style="padding-left:45px;">家庭影院</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=187" class="filtrate_list_li_a " style="padding-left:45px;">烟机/灶具</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=188" class="filtrate_list_li_a " style="padding-left:45px;">热水器</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=189" class="filtrate_list_li_a " style="padding-left:45px;">消毒柜/洗碗机</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=190" class="filtrate_list_li_a " style="padding-left:45px;">冷柜/冰吧</a></li>

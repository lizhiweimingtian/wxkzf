...
<div class="u-brand">
  <div class="p-relative"> <a href="<?php echo $this->_var['brand_data']['url']; ?>" class="u-brand-pic J_item-list"> <img src="<?php echo $this->_var['brand_data']['brand_img']; ?>" class="BrandMer_star"> </a></div>

...
if ($this->_foreach['name']['total'] > 0):
    foreach ($_from AS $this->_var['cat']):
        $this->_foreach['name']['iteration']++;
?>      
      <dl style="display: none; margin-top:46px;<?php if (($this->_foreach['name']['iteration'] <= 1)): ?>display: block;<?php endif; ?>"> 
        <?php
...
?>
<a href="category.php?id=<?php echo $this->_var['cat']['id']; ?>"> <img src="<?php echo $this->_var['ad']['image']; ?>" height="120"><strong style=" color:#FFF"></strong></a>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
<?php else: ?>
<a href="category.php?id=<?php echo $this->_var['cat']['id']; ?>"> <img src="themesmobile/68ecshopcom_mobile/images/catalog.jpg" height="120"><strong style=" color:#FFF"></strong></a>
<?php endif; ?>
		</span>

...
<div class="list_top" >
    	<div class="ub" >
         ...
         <?php if ($this->_var['pager']['sort'] == 'shop_price'): ?><?php if ($this->_var['pager']['order'] == 'ASC'): ?>价格最低<?php else: ?>价格最高<?php endif; ?><?php endif; ?>
         <?php if ($this->_var['pager']['sort'] == 'salenum'): ?><?php if ($this->_var['pager']['order'] == 'ASC'): ?>销量最低<?php else: ?>销量最高<?php endif; ?><?php endif; ?>
         <?php if ($this->_var['pager']['sort'] == 'last_update'): ?><?php if ($this->_var['pager']['order'] == 'ASC'): ?>最近更新<?php else: ?>较早更新 <?php endif; ?><?php endif; ?>
         <?php if ($this->_var['pager']['sort'] == 'goods_id'): ?><?php if ($this->_var['pager']['order'] == 'ASC'): ?>较早上架<?php else: ?>最新上架<?php endif; ?><?php endif; ?>
            </div></div>
            ...
            <div class="list_tab ub ub-ac ub-pc" style="width:10%; background:none"><a href="javascript:;" class="show_type <?php if ($this->_var['pager']['display'] == 'grid'): ?> show_list<?php endif; ?>">&nbsp;</a></div>
        </div>
        </div>
        
    <div id="fenleitanchu" class='zitidian_div' style="display:none">
     <div class="f_bg fenleilist" style="overflow-y:scroll; height:auto">
            <div id="menu0" onClick="javascript:location.href='<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=shop_price&order=<?php if ($this->_var['pager']['sort'] == 'shop_price' && $this->_var['pager']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>'">价格</div>
            <div id="menu1" onClick="javascript:location.href='<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=salenum&order=<?php if ($this->_var['pager']['sort'] == 'salenum' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>'">销量</div>
            <div id="menu2" onClick="javascript:location.href='<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=last_update&order=<?php if ($this->_var['pager']['sort'] == 'last_update' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>'">更新</div>
            <div id="menu3" onClick="javascript:location.href='<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=goods_id&order=<?php if ($this->_var['pager']['sort'] == 'goods_id' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>'">最新</div>
     </div>
...
<?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_61294900_1470310397');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_61294900_1470310397']):
?>
<li <?php if ($this->_var['brand_0_61294900_1470310397']['selected']): ?>class="on"<?php endif; ?>  id="brand_<?php echo $this->_var['brand_0_61294900_1470310397']['brand_id']; ?>"><a href="javascript:get_brand('<?php echo $this->_var['brand_0_61294900_1470310397']['brand_id']; ?>')"><?php echo $this->_var['brand_0_61294900_1470310397']['brand_name']; ?></a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <div class="filtrate_price"onclick="return 1;">
                 ...
                 <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_61341200_1470310397');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_61341200_1470310397']):
        $this->_foreach['filter_attr_list']['iteration']++;
?>  
        <div class="filtrate_category" >
            <a href="javascript:;" class="filtrate_category_a"><?php echo htmlspecialchars($this->_var['filter_attr_0_61341200_1470310397']['filter_attr_name']); ?><?php echo $this->_var['lang']['colon']; ?> <span class="up_down">全部</span></a>
        </div>
        <ul class="clearfix filtrate_address filtrate_list att_item" id="attrs_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
        <?php $_from = $this->_var['filter_attr_0_61341200_1470310397']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');$this->_foreach['filter_attr'] = array('total' => count($_from), 'iteration' => 0);
...
<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_61597700_1470310397');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_61597700_1470310397']):
        $this->_foreach['filter_attr_list']['iteration']++;
?>

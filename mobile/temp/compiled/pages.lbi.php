<?php if ($this->_var['pager'] && $this->_var['pager']['page_count'] > 1): ?>
      ...
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav">
          ...
          <div class="pagenav-cur" style="vertical-align:bottom">
            <div class="pagenav-text" > <span><?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
...
<?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item']):
?>
  <option <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_var['item']; ?>">第<?php echo $this->_var['key']; ?>页</option>

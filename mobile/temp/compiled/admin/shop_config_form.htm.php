...
?>
            ...
            <?php elseif ($this->_var['var']['code'] == "distrib_rank"): ?>

            	<input type="checkbox" name="all_rank[]" value="-1" <?php if ($this->_var['ranks'] == '-1'): ?>checked="true"<?php endif; ?> onClick="doCheck()"/>全部会员
...
?><input type="checkbox" name="user_rank[]" value="<?php echo $this->_var['user_rank']['rank_id']; ?>" <?php if ($this->_var['user_rank']['checked']): ?>checked="true"<?php endif; ?> onClick="doCheck()" <?php if ($this->_var['ranks'] == '-1'): ?> disabled="disabled"<?php endif; ?>/><?php echo $this->_var['user_rank']['rank_name']; ?> <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            ...
            <table>
              ...
              <tr>
                ...
                <td valign='center'>
                  ...
                  <input type='hidden' name='invoice_enable[2]' value='0'/>

                  <?php if ($this->_var['cfg']['invoice_type']['enable'] [ 2 ] == '1'): ?>

                  <input id='invoice_type2' name="invoice_enable[2]" type="checkbox" value='1' checked=''/>

                  <?php else: ?>

                  <input id='invoice_type2' name="invoice_enable[2]" type="checkbox" value='1' />

                  <?php endif; ?>

                  <input name='invoice_type[]' type='text' value='<?php echo $this->_var['cfg']['invoice_type']['type']['2']; ?>'/>

                </td>

                <td valign='center'><input name="invoice_rate[]" type="text" value="<?php echo $this->_var['cfg']['invoice_type']['rate']['2']; ?>" /></td>
...
function  doCheck()
{ 
	var r=document.getElementsByName("user_rank[]");
	var j=document.getElementsByName("all_rank[]");

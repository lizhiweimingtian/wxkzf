...
function get_zhekou($goods_id)
{
    ...
    /* 取得商品信息 */
    $sql = "SELECT g.market_price,g.shop_price ,g.promote_start_date,g.promote_end_date, g.promote_price".
        ...
        else
        {
            if ($goods['market_price'] == 0){
              $zhekou = 0;
				...
				$zhekou = (number_format($goods['shop_price']/$goods['market_price'],2))*10;
			} 
        }
	}
    return $zhekou;

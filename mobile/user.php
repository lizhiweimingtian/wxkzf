...
function action_login()
{
	...
	if(empty($back_act))
	{
		...
		{
                    if(isset($_REQUEST['jump']) && trim($_REQUEST['jump'])=='balance'){
...
// 	);
	$profile = array(
		'user_id' => $user_id,'sex' => isset($_POST['sex']) ? intval($_POST['sex']) : 0,'birthday' => $birthday,'other' => isset($other) ? $other : array()
	);

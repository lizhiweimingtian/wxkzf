...
?>
                <li>
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    <tr>
                      <td align="left" class="font2" width='50%'>编号：<?php echo $this->_var['item']['rebate_id']; ?></td>
                    ...
                    <tr>
                      ...
                      <td align="left">返佣状态：<?php echo $this->_var['item']['pay_status']; ?></td>
                    </tr>
                    <tr>
                      <td align="left">返佣日期：<?php if ($this->_var['item']['formatted_pay_time']): ?><?php echo $this->_var['item']['formatted_pay_time']; ?><?php else: ?><font style='color:red'>无</font><?php endif; ?></td>
                      <td align="left">

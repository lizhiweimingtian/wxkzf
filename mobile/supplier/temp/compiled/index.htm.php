          ...
          <div class="index">
            <ul class="index_menu_one">
              ...
              <li>
               ...
               <li>
                <a href="supplier_rebate.php?act=list&is_pay_ok=0" class="index_menu7">
                <span>平台佣金</span>
                </a>
              </li>
              <li>
                <a href="supplier_store_rebate.php?act=list&is_pay_ok=0" class="index_menu8">
                <span>配送商佣金</span>
                </a>
              </li>
              <li>
                <a href="goods_stock.php?act=list" class="index_menu9">
                <span>库存查询</span>
                </a>
              </li>
            </ul>

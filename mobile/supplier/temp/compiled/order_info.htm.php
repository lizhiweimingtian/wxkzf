...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <form method='POST' action='order.php' onsubmit='return quick_delivery();'>
          <div class="order_info_con">
            <p class="one_delivery">
              <input type="text" name="express_no" id='express_no' placeholder="请输入发货编号/快递单号" class="inputBg"/>
      ...
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['pay']): ?>
        <input name="pay" type="submit" value="<?php echo $this->_var['lang']['op_pay']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['unpay']): ?>
        <input name="unpay" type="submit" class="one_delivery_btn" value="<?php echo $this->_var['lang']['op_unpay']; ?>" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['prepare']): ?>
        <input name="prepare" type="submit" value="<?php echo $this->_var['lang']['op_prepare']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['split']): ?>
        <input name="ship" type="submit" value="<?php echo $this->_var['lang']['op_split']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['unship']): ?>
        <input name="unship" type="submit" value="<?php echo $this->_var['lang']['op_unship']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['receive']): ?>
        <input name="receive" type="submit" value="<?php echo $this->_var['lang']['op_receive']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['cancel']): ?>
        <input name="cancel" type="submit" value="<?php echo $this->_var['lang']['op_cancel']; ?>" class="one_delivery_btn" />
        <?php endif; ?> <?php if ($this->_var['operable_list']['invalid']): ?>
        <input name="invalid" type="submit" value="<?php echo $this->_var['lang']['op_invalid']; ?>" class="one_delivery_btn" />
        ...
        <input name="to_delivery" type="submit" value="<?php echo $this->_var['lang']['op_to_delivery']; ?>" class="one_delivery_btn"/>
        <input name="order_sn" type="hidden" value="<?php echo $this->_var['order']['order_sn']; ?>" />
        <?php endif; ?> <input name="after_service" type="submit" value="<?php echo $this->_var['lang']['op_after_service']; ?>" class="one_delivery_btn" /><?php if ($this->_var['operable_list']['remove']): ?>
        <input name="remove" type="submit" value="<?php echo $this->_var['lang']['remove']; ?>" class="one_delivery_btn" onClick="return window.confirm('<?php echo $this->_var['lang']['js_languages']['remove_confirm']; ?>');" />
        <?php endif; ?>
        ...
        <input name="assign" type="submit" value="<?php echo $this->_var['lang']['op_assign']; ?>" class="one_delivery_btn" onclick="return assignTo(document.forms['theForm'].elements['agency_id'].value)" />
...
?>
              <table width="100%" >
                ...
                <tr>
                  <td><?php echo $this->_var['goods']['formated_goods_price']; ?> X <span><?php echo $this->_var['goods']['goods_number']; ?>（数量）</span></td>
          ...
          <div class="order_base">
            ...
            <div class="base_info">
              ...
              <p>支付方式：<?php echo $this->_var['order']['pay_name']; ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=payment" class="special" style="display:none">编辑</a></p>
              <p>配送方式：<?php echo $this->_var['order']['shipping_name']; ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special" style="display:none">编辑</a></p>

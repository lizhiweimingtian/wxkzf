              ...
              <li>
                <table width="100%" cellpadding="3" cellspacing="1">
                  ...
                  <tr>
                    ...
                    <td align='right' width='50%'><a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>">查看订单</td>
                  </tr>
                </table>
              </li>
              <?php endforeach; else: ?>
...
?>
              <li>
                <table width="100%" cellpadding="3" cellspacing="1">
                  ...
                  <tr>
                    <td align='left' width='50%'>订单状态：<?php echo $this->_var['lang']['os'][$this->_var['order']['order_status']]; ?>,<?php echo $this->_var['lang']['ps'][$this->_var['order']['pay_status']]; ?>,<?php echo $this->_var['lang']['ss'][$this->_var['order']['shipping_status']]; ?></td>
                    <td align='right' width='50%' style="border:1px red solid"><a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>">查看订单</td>
                  </tr>
                </table>
              </li>
              <?php endforeach; else: ?>

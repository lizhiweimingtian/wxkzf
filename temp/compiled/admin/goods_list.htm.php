...
?>
  <tr>
    ...
    <?php if ($this->_var['goods']['supplier_status'] == '-1'): ?>
    审核未通过
    <?php else: ?>
    <img src="images/<?php if ($this->_var['goods']['supplier_status'] == '1'): ?>yes<?php elseif ($this->_var['goods']['supplier_status'] == '0'): ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_status', <?php echo $this->_var['goods']['goods_id']; ?>)" />
    <?php endif; ?>
    <?php endif; ?>
</td>	
	<?php endif; ?>
...
<div>
  ...
  <select name="type" id="selAction" onchange="changeAction()">
    ...
    <?php if ($this->_var['suppliers_exists'] == 1): ?>
    <option value="pass_audit"><?php echo $this->_var['lang']['pass_audit']; ?></option>
    <option value="not_audit"><?php echo $this->_var['lang']['not_audit']; ?></option>
    <option value="not_pass_audit"><?php echo $this->_var['lang']['not_pass_audit']; ?></option>
    <?php endif; ?>

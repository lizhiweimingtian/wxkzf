...
<div class="form-div">
	<form action="javascript:searchUser()" name="searchForm">
		...
		<input type="text" name="keyword" placeholder="手机号/用户名/邮箱" />
...
?>
			<tr>
				...
				<td class="first-cell">
					...
					<span style="border: 1px green solid; background-color: #6DD26A; padding: 1px 2px 0px 2px; color: white; display: inline; border-radius: 2px;">
					...
					<span style="margin-left: 5px; border: 1px #D47C04 solid; background-color: #FBB24E; padding: 1px 2px 0px 2px; color: white; display: inline; border-radius: 2px;"> <?php echo $this->_var['user']['rank_name']; ?> </span>
					<!-- <?php endif; ?> -->
				</td>
				<td>

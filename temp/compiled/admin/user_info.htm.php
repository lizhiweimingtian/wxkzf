...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/transport.org.js,../js/region.js,validator.js')); ?>
<div class="main-div">
...
?>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      <!-- <input type="button" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="button"  onclick="validate()"/> -->
...
function validate()
{
    ...
    {
		validator.addErrorMsg("邮箱和手机号码至少要填写一项！");

						...
						<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
							...
							<div class="m m5" id="safe05">
								<div class="mc">
									...
									<div class="fore3">
										<a href="security.php?act=password_reset" class="btn btn-7">修改</a>
									</div>
								</div>
								<div class="mc">
									<div class="fore1">
									...
									<div class="fore3">
										...
										<?php else: ?>
										<a href="security.php?act=email_binding" class="btn btn-7">修改</a>
										<?php endif; ?>
									</div>
								</div>
								<div class="mc">
									...
									<div class="fore3">
										...
										<?php else: ?>
										<a href="security.php?act=mobile_binding" class="btn btn-7">修改</a>
										<?php endif; ?>
									</div>
								</div>

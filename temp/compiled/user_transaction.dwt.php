...
<div id="popup_window" style="position:fixed;display:none;">
  ...
  <input id="surplus_password_input1" type="password"/>
  <label id="surplus_label2">请确认余额支付密码</label>
  <input id="surplus_password_input2" type="password"/>
  <input class='bnt_blue_1 btn_pay1' type="button" onclick="end_input_surplus()" value="确定"/>
  <input class='bnt_blue_1 btn_pay1' type="button" onclick="cancel_input_surplus()" value="取消"/>
</div>
...
联系人QQ号：XX<?php endif; ?>
	...
	function supplier_Reg()
	{
		...
		else
		{
          ...
          <div class="tabmenu">
    		<ul class="tab pngFix">
  				<li class="first active"><a>提货券入口</a></li>
            </ul>
          </div>
          <div class="mar_top">
              ...
              <table width="100%" border="0"  cellpadding="10" cellspacing="1"  bgcolor="#E6E6E6">
                <tr>
                  ...
                  <td width="72%" align="left" bgcolor="#FFFFFF">
                    <input type="text" name="username" value="<?php echo $this->_var['profile']['user_name']; ?>" onblur="check_username(this.value)" size="25" class="inputBg" />
            ...
            <div class="ncm-default-form"  id="con_tab_2" style="display:none">
               ...
               <dl>
        		...
        		<dd>
          			...
          			<p class="hint mt5">完善个人信息资料，上传头像图片有助于您结识更多的朋友。<br /><span style="color:orange;">头像最佳默认尺寸为120x120像素。</span></p>
        		</dd>
      		</dl>
      		<dl>
...
?>
        ...
        <?php endif; ?>            
            ...
            <tr>
                ...
                <td align="left" bgcolor="#FFFFFF">正面：<input type="file" name="face_card"  class="inputBg"/><br /><?php if ($this->_var['profile']['face_card'] != ''): ?><img src="<?php echo $this->_var['profile']['face_card']; ?>" width="160" height="160"/><?php endif; ?></td>
            </tr>
            <tr>
            	<td align="right" bgcolor="#FFFFFF">&nbsp;</td>
                <td align="left" bgcolor="#FFFFFF">反面：<input type="file" name="back_card"  class="inputBg"/><br /><?php if ($this->_var['profile']['back_card'] != ''): ?><img src="<?php echo $this->_var['profile']['back_card']; ?>" width="150" height="150" /><?php endif; ?></td>
            </tr>
            <tr>
...
?>
      ...
      <h5 class="user-title user-title-t"><span>修改支付密码</span></h5><div class="blank"></div>
      ...
      <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
        ...
        <tr>
          <td align="right" bgcolor="#ffffff">&nbsp;</td>
          <td align="left" bgcolor="#ffffff">
            <input type="submit" class="bnt_blue_1" value="确定" />
            <input type='hidden' name='course' value='update'/>
          </td>
        </tr>
      </table>
      </form>
	...
	function get_verify_code()
      ...
      <h5 class="user-title user-title-t"><span>忘记支付密码</span></h5><div class="blank"></div>
      ...
      <tbody>
          ...
          <td align="left" bgcolor="#ffffff">
            <select onchange='change_option(this)'>
              <option value="select_none" selected="selected">请选择找回密码方式</option>
              <?php if ($this->_var['info']['is_validated'] == 1): ?><option value="send_by_email">邮箱找回密码</option><?php endif; ?>
              <?php if ($this->_var['info']['validated'] == 1): ?><option value="send_by_phone">手机找回密码</option><?php endif; ?>
            </select>
          </td>
        </tr>
      </tbody>
      ...
      <tbody id="send_phone_tbody" style="display:none">
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><?php echo $this->_var['info']['mobile_phone']; ?><input id='v_phone' type="hidden" name="v_phone" value="<?php echo $this->_var['info']['mobile_phone']; ?>"/></td>
        </tr>
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><input type="text" id='v_code' name="v_code" class="inputBg" />
            ...
            <span id="code_notice" style="color:#999"></span>
          </td>
        </tr>
        <tr>
          <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
          <td align="left" bgcolor="#FFFFFF">
            <input type="submit" class="bnt_blue_1" value="提交" />
          </td>
        </tr>
      </tbody>
        <?php endif; ?>
        ...
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><?php echo $this->_var['info']['email']; ?><input type="hidden" name="v_email" value="<?php echo $this->_var['info']['email']; ?>"/></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">验证码：</td>
          <td align="left" bgcolor="#ffffff">
            <input type="text" id='v_captcha' name="v_captcha"  class="inputBg"/>
            <img src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;margin-left:10px;margin-top:-3px" onClick="this.src='captcha.php?is_login=1&'+Math.random()" />
          </td>
        </tr>
        <tr>
          <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <h5 class="user-title user-title-t"><span>重置余额支付密码</span></h5><div class="blank"></div>
      <form action="user.php?act=act_update_surplus_password" method="post" onsubmit='return check_reset_surplus_password(this)'>
      <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
      	<tr>
          <td align="right" bgcolor="#FFFFFF">新支付密码： </td>
          <td align="left" bgcolor="#ffffff">
            <input type="password" id='surplus_password_input1' name="surplus_password1" class="inputBg"/>
          </td>
        </tr>
        <tr>
          <td align="right" bgcolor="#FFFFFF">确认密码： </td>
          <td align="left" bgcolor="#ffffff">
            <input type="password" id='surplus_password_input2' name="surplus_password2" class="inputBg"/>
          </td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">&nbsp;</td>
          <td align="left" bgcolor="#ffffff">
            <input type="submit" class="bnt_blue_1" value="确认" />
            ...
            <?php endif; ?>
            <input type='hidden' name='course' value='reset'/>
          </td>
        </tr>
      </table>
      </form>
      ...
      <h5 class="user-title user-title-t"><span>修改已验证邮箱</span></h5><div class="blank"></div>
      <form action="user.php" method="post">
      <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
      	<tr>
          <td align="right" bgcolor="#FFFFFF">已验证邮箱： </td>
          <td align="left" bgcolor="#ffffff"><?php echo $this->_var['email']; ?><input type="hidden" name="v_email" value="<?php echo $this->_var['email']; ?>"  class="inputBg"/></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">验证码：</td>
          <td align="left" bgcolor="#ffffff"><input type="text" name="v_captcha"  class="inputBg"/><img src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;margin-left:10px;margin-top:-3px" onClick="this.src='captcha.php?is_login=1&'+Math.random()" /></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">&nbsp;</td>
          <td align="left" bgcolor="#ffffff"><input type="submit" class="bnt_blue_1" value="发送验证邮件" /><input type="hidden" name="act" value="act_update_email" /></td>
        </tr>
      </table>
      </form>
      <?php endif; ?>
      ...
      <h5 class="user-title user-title-t"><span>邮箱设置信息</span></h5><div class="blank"></div>
      	<form action="user.php" method="post">
      	<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
      	<tr>
          <td width="28%" align="right" bgcolor="#FFFFFF">我的邮箱： </td>
          <td width="72%" align="left" bgcolor="#ffffff"><input type="text" name="new_email" value="<?php if ($this->_var['info']['is_validated'] == 0): ?><?php echo $this->_var['info']['email']; ?><?php endif; ?>"  class="inputBg"/>&nbsp;&nbsp;这里是您想<?php if ($this->_var['info']['is_validated'] != 0): ?>修改<?php endif; ?>绑定的邮箱地址</td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">验证码：</td>
          <td align="left" bgcolor="#ffffff"><input type="text" name="code"  class="inputBg"/><img src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;margin-left:10px;margin-top:-3px" onClick="this.src='captcha.php?is_login=1&'+Math.random()" /></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">&nbsp;</td>
          <td align="left" bgcolor="#ffffff"><input type="submit" class="bnt_blue_1" value="提交" /><input type="hidden" name="act" value="act_binding_email" /></td>
        </tr>
        </table>
        </form>
      <?php endif; ?>
      ...
      <h5 class="user-title user-title-t"><span>修改已验证手机</span></h5><div class="blank"></div>
      <form action="user.php" method="post">
      <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
      	<tr>
          <td align="right" bgcolor="#FFFFFF">已验证手机： </td>
          <td align="left" bgcolor="#FFFFFF"><?php echo $this->_var['phone']; ?><input type="hidden" name="v_phone" value="<?php echo $this->_var['phone']; ?>"/></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
          <td align="left" bgcolor="#FFFFFF"><input type="button" onclick="getverifycode2(<?php echo $this->_var['phone']; ?>);" class="bnt_blue_1" value="点击获取" id="v_code_btn"/> <span id="v_code_notice" style="color:#999"></span></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#FFFFFF">手机验证码：</td>
        ...
        <tr>
          <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
          <td align="left" bgcolor="#FFFFFF"><input type="submit" class="bnt_blue_1" value="提交" /><input type="hidden" name="act" value="act_update_phone" /></td>
        </tr>
      </table>
      </form>
      <?php endif; ?>
      ...
      <?php echo $this->smarty_insert_scripts(array('files'=>'utils.js')); ?>
     <?php echo $this->smarty_insert_scripts(array('files'=>'sms.js')); ?>
      <h5 class="user-title user-title-t"><span>手机号修改结果</span></h5><div class="blank"></div>
     <form action="user.php" method="post" name="binding">
      <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E6E6E6">
      	<tr>
          <td align="right" bgcolor="#ffffff">手机号：</td>
          <td align="left" bgcolor="#ffffff"><input type="text" id="phone" name="phone" class="inputBg" onblur="check_phone(this.value)"/><span id="phone_message" style="color:#F00"> *</span></td>
        </tr>
        <tr>
          <td align="right" bgcolor="#ffffff">验证码：</td>
          <td align="left" bgcolor="#ffffff"><input type="text" size="8" name="verifycode" class="inputBg" />
      		<input type="button" onclick="getverifycode1();" class="bnt_blue_1" value="点击获取" id="code_btn"/> <span id="code_notice" style="color:#999"></span></td>
        </tr>
        <tr>
          <td bgcolor="#ffffff">&nbsp;</td>
          <td align="left" bgcolor="#ffffff"><input type="submit" value="提交" class="bnt_blue_1" style="width:100px; height:30px;" /><input type="hidden" name="act" value="binding" /></td>
        </tr>
      </table>
      </form>
      <?php endif; ?>
...
?>
          		...
          		<li <?php if ($this->_foreach['name']['iteration'] % 4 == 0): ?>style="margin:0px 0px 11px 0px"<?php endif; ?>>
                    ...
                    <p>红包序列号：<?php echo empty($this->_var['hong']['bonus_sn']) ? 'N/A' : $this->_var['hong']['bonus_sn']; ?></p>
                    <p>发行店铺：<a href="<?php if ($this->_var['hong']['supplier_id'] == 0): ?>index.php<?php else: ?>supplier.php?suppId=<?php echo $this->_var['hong']['supplier_id']; ?><?php endif; ?>" target="_blank"><?php echo $this->_var['hong']['supplier_name']; ?></a></p>
          ...
          <div id="J_Remide" class="remide-box">
            ...
            <ul>
              <li><a href="user.php?act=order_list&composite_status=<?php echo $this->_var['status']['unconfirmed']; ?>">未确认订单<span class="num">(<?php echo $this->_var['order_count']['unconfirmed']; ?>)</span></a></li>
              <li><a href="user.php?act=order_list&composite_status=<?php echo $this->_var['status']['await_pay']; ?>">待付款<span class="num">(<?php echo $this->_var['order_count']['await_pay']; ?>)</span></a></li>
              <li><a href="user.php?act=order_list&composite_status=<?php echo $this->_var['status']['await_ship']; ?>">待发货<span class="num">(<?php echo $this->_var['order_count']['await_ship']; ?>)</span></a></li>
              <li><a href="user.php?act=order_list&composite_status=<?php echo $this->_var['status']['finished']; ?>">已成交订单数<span class="num">(<?php echo $this->_var['order_count']['finished']; ?>)</span></a></li>
            </ul>
          </div>
            ...
            <tbody class="close-order">
              ...
              <tr class="order-hd">
                <td colspan="8"><span class="no">
                  ...
                  </span> <span class="deal-time">&nbsp;&nbsp;成交时间：<?php echo $this->_var['item']['order_time']; ?></span> <span class="deal-time">&nbsp;&nbsp;商家店铺：<?php echo $this->_var['item']['shopname']; ?></span></td>
              </tr>
...
?>
                  ...
                  <div class="goods_desc <?php if (($this->_foreach['goods']['iteration'] == $this->_foreach['goods']['total'])): ?>last<?php endif; ?>"> <a class="pic" href="<?php echo $this->_var['goods']['url']; ?>" title="查看宝贝详情" target="_blank"> 
...
?>
                  ...
                  <div class="goods_desc price  <?php if (($this->_foreach['goods']['iteration'] == $this->_foreach['goods']['total'])): ?>last<?php endif; ?>" style="padding-left:0px; line-height:60px;"> <?php echo $this->_var['goods']['formated_goods_price']; ?> </div>
...
?>
                  ...
                  <div class="goods_desc  <?php if (($this->_foreach['goods']['iteration'] == $this->_foreach['goods']['total'])): ?>last<?php endif; ?>" style="padding-left:0px;line-height:60px;"> <?php echo $this->_var['goods']['goods_number']; ?> </div>
...
?>
			...
			<?php if ($this->_var['goods']['back_can'] == 1): ?>
				<?php if ($this->_var['item']['order_status1'] != 2): ?>
					<?php if (( $this->_var['item']['shipping_status'] == 0 || $this->_var['item']['shipping_status'] == 3 ) && $this->_var['item']['pay_status'] == 2): ?>
					<a href="user.php?act=back_order&order_id=<?php echo $this->_var['item']['order_id']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&product_id=<?php echo $this->_var['goods']['product_id']; ?>&x=1" class="red2" >退款(整个订单)</a><br />
					<?php endif; ?>
			...
			<?php else: ?>
			<p>
			[<?php echo $this->_var['goods']['back_can_no']; ?>]
			</p>
			<?php endif; ?>
		...
		<td rowspan="1" align="center" class="amount no-border-right"><p class="post-type"><strong>
                ...
                <td rowspan="1" align="center" class="trade-status no-border-right"><?php echo $this->_var['item']['order_status']; ?></br>
                  ...
                  <div onmouseover="showSubNav('subNav_<?php echo $this->_var['item']['invoice_no']; ?>');"> 
                    <?php else: ?>
                <div onmouseover="showSubNav2('subNav_<?php echo $this->_var['item']['invoice_no']; ?>','<?php echo $this->_var['item']['shipping_name_2']; ?>','<?php echo $this->_var['item']['invoice_no']; ?>');">
                      <?php endif; ?> 
                <a href="javascript:;" class="nav_a">物流跟踪</a></div>
                    <div id="subNav_<?php echo $this->_var['item']['invoice_no']; ?>" class="wuliu" style="display:none; position:absolute;">
                      <div class="wuliu_info">
                        <div class="wuliu_info_name"><?php echo $this->_var['item']['shipping_name']; ?></div>
                        <div class="wuliu_info_num">运单号：<?php echo $this->_var['item']['invoice_no']; ?></div>
                        <div><img src="themes/68ecshopcom_360buy/images/drop.gif" width="12" height="12" onclick="hiddenSubNav('subNav_<?php echo $this->_var['item']['invoice_no']; ?>')" /></div>
                      </div>
                      <?php if ($this->_var['item']['result_content']): ?> 
                ...
                <td rowspan="1" align="center" class="other">
                  ...
                  <font class="red2"><?php echo $this->_var['item']['handler']; ?></font></br>
            		...
            		<?php if ($this->_var['item']['order_status1'] == 5 && $this->_var['item']['shipping_status'] == 2): ?>
                  <?php if ($this->_var['item']['comment_s'] == 0): ?> 
                  已全部评价 
                  <?php else: ?> 
                  <a href="user.php?act=my_comment&s=<?php echo $this->_var['item']['comment_s']; ?>#commtr_<?php echo $this->_var['item']['comment_s']; ?>" class="on_comment">评价</a> 
                  <?php endif; ?><br />
        ...
        function showSubNav2(id,s_name,s_no)
		{
			if (id != document.getElementById("s_have_hidden").value)
			{
				if (document.getElementById("s_have_hidden").value != 0)
				...
				document.getElementById(id).style.display = 'block';
				document.getElementById("retData2").innerHTML="<center>正在查询物流信息，请稍后...</center>";
				document.getElementById("s_have_hidden").value = id;
				var expressid2 = s_name;
				var expressno2 = s_no;
				Ajax.call('plugins/kuaidi100/kuaidi100_post.php?com='+ expressid2+'&nu=' + expressno2,'showtest=showtest', function(data2){document.getElementById("retData2").innerHTML=data2;}, 'GET', 'TEXT');
			}
		}
...
?>
              ...
              <tr>
                <td colspan=2 align=center><input type="hidden" name="act" value="back_order_act">
                  ...
                  <input name="reset" type="reset" value="取消" class="bnt_blue_1" style="border:none;" /></td>
              </tr>
            </table>
            <script>
	...
	function  add_huan_goods(goods_id)
	{
	   ...
	   Ajax.call('user.php?act=add_huan_goods', 'goods=' + $.toJSON(goods), add_huan_goodsResponse, 'POST', 'JSON');
	}
...
?> 
	      ...
	      <th width="10%" align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_shouhou']; ?></th>
...
?>
			  ...
			  <?php echo $this->_var['goods']['shouhou']; ?>
			  </td>
...
?>
                  ...
                  <div class="payment_subbox" id="payment_subbox" style="display:none">
                    <link href="themes/68ecshopcom_360buy/css/style_jm.css" rel="stylesheet" type="text/css" />
...
?>
              ...
              <tr>
                <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['phone']; ?>：</td>
                <td align="left" bgcolor="#ffffff"><input name="tel" type="text" class="inputBg" id="tel_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['tel']); ?>" /></td>
                <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['backup_phone']; ?>：</td>

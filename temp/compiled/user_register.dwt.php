...
?>
							...
							<div class="item">
								...
								<div>
									<span class="label" <?php if ($this->_var['field']['is_need']): ?>id="extend_field<?php echo $this->_var['field']['id']; ?>ii"<?php endif; ?>></span>
								</div>
							</div>
							<?php endif; ?>
							...
							<div class="item">
								...
								<input type="hidden" name="back_act" value="user.php?act=login" />

...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,selectzone_bd.js,validator.js,category_selecter.js')); ?>
<!-- zTree Style -->
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
		...
		<tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_cat']; ?></td>
			<td >
			<input type="text" id="cat_name" name="cat_name" nowvalue="<?php echo $this->_var['goods_cat_id']; ?>" value="<?php echo $this->_var['goods_cat_name']; ?>" style="cursor: pointer;">
            ...
            <table width="400" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80087500_1447476594');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80087500_1447476594']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_80087500_1447476594']['name_p'] >= "a" && $this->_var['brand_list_0_80087500_1447476594']['name_p'] <= "g"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_80087500_1447476594']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80087500_1447476594']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80087500_1447476594']['name']; ?>')"><?php echo $this->_var['brand_list_0_80087500_1447476594']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px"> 
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80111400_1447476594');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80111400_1447476594']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_80111400_1447476594']['name_p'] >= "h" && $this->_var['brand_list_0_80111400_1447476594']['name_p'] <= "k"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_80111400_1447476594']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80111400_1447476594']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80111400_1447476594']['name']; ?>')"><?php echo $this->_var['brand_list_0_80111400_1447476594']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80134700_1447476594');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80134700_1447476594']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_80134700_1447476594']['name_p'] >= "l" && $this->_var['brand_list_0_80134700_1447476594']['name_p'] <= "s"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_80134700_1447476594']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80134700_1447476594']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80134700_1447476594']['name']; ?>')"><?php echo $this->_var['brand_list_0_80134700_1447476594']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80157600_1447476594');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80157600_1447476594']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_80157600_1447476594']['name_p'] >= "t" && $this->_var['brand_list_0_80157600_1447476594']['name_p'] <= "z"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_80157600_1447476594']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80157600_1447476594']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80157600_1447476594']['name']; ?>')"><?php echo $this->_var['brand_list_0_80157600_1447476594']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80180400_1447476594');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80180400_1447476594']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_80180400_1447476594']['name_p'] >= "0" && $this->_var['brand_list_0_80180400_1447476594']['name_p'] <= "9"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_80180400_1447476594']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80180400_1447476594']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80180400_1447476594']['name']; ?>')"><?php echo $this->_var['brand_list_0_80180400_1447476594']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                </tr>
...
function getElementsByClassName(n)
{
  ...
  function validate(goods_id)
  {
	  ...
	  validator.required('cat_id', goods_cat_not_null);

...
<div id="popDiv" class="mydiv" style="display:none;">
  ...
  <div class="qb_right"><a href="javascript:closeDiv()" ><img src="themes/68ecshopcom_360buy/images/upgrade_ad/quick_buy_close.gif"  style="padding:8px 10px 0 0;border:none;"></a></div>
...
<table>  
    ...
    <tr> 
      ...
      <select style="border: 1px solid rgb(204, 204, 204);" onchange="region.changed(this, 1, 'selProvinces_')" id="selCountries_" name="country"> 
       <option value="0">请选择<?php echo $this->_var['name_of_region']['0']; ?></option>
...
?>
	  ...
	  <select name="province" id="selProvinces_<?php echo $this->_var['sn']; ?>" onchange="region.changed(this, 2, 'selCities_<?php echo $this->_var['sn']; ?>')" style="border:1px solid #ccc;">
            <option value="0">请选择<?php echo $this->_var['name_of_region']['1']; ?></option>
...
?>
          ...
          <select name="city" id="selCities_<?php echo $this->_var['sn']; ?>" onchange="region.changed(this, 3, 'selDistricts_<?php echo $this->_var['sn']; ?>')" style="border:1px solid #ccc;">
            <option value="0">请选择<?php echo $this->_var['name_of_region']['2']; ?></option>
...
?>
          ...
          <select name="district" id="selDistricts_<?php echo $this->_var['sn']; ?>" <?php if (! $this->_var['district_list'][$this->_var['sn']]): ?>style="display:none;border:1px solid #ccc;"<?php endif; ?>>
            <option value="0">请选择<?php echo $this->_var['name_of_region']['3']; ?></option>
...
?>
    ...
    <tr> 
      ...
      <input type="hidden" value="<?php echo $_SESSION['takegoods_id_www_com']; ?>" name="takegoods_id_www_com" >

<div class="navList">
	...
	<a href="user.php?act=vc_login" class="item <?php if ($this->_var['action'] == 'vc_login'): ?>curs<?php endif; ?>"><span>储值卡充值</span><i></i></a>
	...
	<?php if ($this->_var['show_transform_points']): ?> 
        ...
        <a href="user.php?act=team_manage" class="item <?php if ($this->_var['action'] == 'team_manage'): ?>curs<?php endif; ?>"><span>财富团队</span><i></i></a>

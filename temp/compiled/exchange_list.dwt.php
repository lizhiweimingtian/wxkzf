    ...
    <div id="JS_slider" class="act-slider Left">
      <div class="stage">
        <table id="JS_slide_stage" cellpadding="0" spellcheck="0" border="0">
          <tbody>
            <tr>
              <td> <?php $this->assign('ads_id','44'); ?><?php $this->assign('ads_num','0'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?> </td>
              <td> <?php $this->assign('ads_id','45'); ?><?php $this->assign('ads_num','0'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?> </td>
              <td> <?php $this->assign('ads_id','46'); ?><?php $this->assign('ads_num','0'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?> </td>
              <td> <?php $this->assign('ads_id','47'); ?><?php $this->assign('ads_num','0'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?> </td>
            </tr>
          </tbody>
        </table>
      </div>

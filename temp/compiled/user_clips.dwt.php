...
?>
                          <li class="favorite-pic-list">
                            <div class="favorite-goods-thumb"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>"  width="220" height="220"></a></div>
                            <div style="top: 0px;" class="favorite-goods-info">
                              <dl>
                                <dt>
                                <?php if ($this->_var['goods']['is_pre_sale'] == 1): ?>
                                <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank">【<span style="color: red;"><?php echo $this->_var['lang']['label_pre_sale']; ?></span>】<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a>
                                <?php else: ?>
                                <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a>
                                <?php endif; ?>
                                </dt>
                                <dd> <span> <strong> 
...
$(document).ready(function() {
	...
	function() {
		...
		400, "swing");
              ...
              <div class="tabmenu">
                <ul class="tab pngFix">
                  <li class="first active"><a><?php echo $this->_var['lang']['label_affiliate']; ?></a></li>
                </ul>
              </div>
              <div class="mar_top">
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['lang_list'])); ?>
                    ...
                    <tr>
                      <td colspan="2" align="center" bgcolor="#ffffff"><input type="button" name="gen_code" value="<?php echo $this->_var['lang']['generate']; ?>" onclick="genCode()" class="bnt_blue_1" /></td>
                    </tr>
                    <tr>
...
?>
                  <tr align="center">
                    ...
                    <td bgcolor="#ffffff"><?php if ($this->_var['val']['separate_type'] == 1 || $this->_var['val']['separate_type'] === 0): ?> 
                      ...
                      <?php endif; ?></td>
                    <td bgcolor="#ffffff"><?php echo $this->_var['lang']['affiliate_stats']['\$val']['is_separate']; ?></td>
                  </tr>
                  <?php endforeach; else: ?>
                  <tr>

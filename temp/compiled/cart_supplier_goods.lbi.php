...
<tr height="35">
  <td colspan="6" style="border-top:1px solid #d9d9d9; text-indent:19px; background:#FAFAFA;font-weight:bold;color:#FF0000"><?php echo $this->_var['cartgoods']['supplier_name']; ?><input type="hidden" name="supplierid" id="supplierid" value="<?php echo $this->_var['key']; ?>"></td>
</tr>
</table>
<table align="center" cellpadding="0" cellspacing="0" style="height:auto;width:100%;">
...
?>
<tr>
  <td style="width:100%;<?php if (! ($this->_foreach['goods_list']['iteration'] == $this->_foreach['goods_list']['total'])): ?>border-bottom:1px dashed #ddd;<?php endif; ?>">
  	<table cellpadding="0" cellspacing="1" width="100%" <?php if (! $this->_var['goods']['is_cansel']): ?>style="background:#ddd;"<?php endif; ?>>
      <tr>
		<td align="center" width="8%">
        	<input type="checkbox" autocomplete="off" name="sel_cartgoods[]" value="<?php echo $this->_var['goods']['rec_id']; ?>" id="sel_cartgoods_<?php echo $this->_var['goods']['rec_id']; ?>" checked=checked onclick="select_cart_goods();">
        </td>
...
?>
        ...
        <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
		  <div class="jm_cartnum"> <span class="jmminu" <?php if ($this->_var['goods']['is_cansel']): ?>onclick="minus_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>,<?php echo $this->_var['key']; ?>);"<?php endif; ?>>-</span>
	    <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="jminputBg"   onKeyDown='if(event.keyCode == 13) event.returnValue = false'  onblur="change_price(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>)" />
	    <input type="hidden" id="hidden_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>">
	    <span class="jmadd" <?php if ($this->_var['goods']['is_cansel']): ?>onclick='javascript:add_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>,<?php echo $this->_var['key']; ?>)' <?php endif; ?>>+</span> </div>
	  	<?php else: ?> 
	  		<?php echo $this->_var['goods']['goods_number']; ?> 
	  	<?php endif; ?></br><?php echo $this->_var['goods']['stock_dec']; ?>
       </td>
	   <td align="center" width="12%"><font class="cart_jmprice" id="goods_price_<?php echo $this->_var['goods']['rec_id']; ?>"><?php echo $this->_var['goods']['goods_price']; ?></font></td>
	   <td align="center" width="12%"><font class="cart_jmprice" id="subtotal_<?php echo $this->_var['goods']['rec_id']; ?>"><?php echo $this->_var['goods']['subtotal']; ?></font></td>
	   <td align="center" width="12%"><a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6"><?php echo $this->_var['lang']['drop']; ?></a></td>
      </tr>
    </table>
  </td>
</tr>

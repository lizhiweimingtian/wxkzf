...
?><?php if ($this->_var['key'] != "sort" && $this->_var['key'] != "order"): ?><?php echo $this->_var['key']; ?>=<?php echo $this->_var['item']; ?>&<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>page=<?php echo $this->_var['pager']['page']; ?>&sort=goods_id&order=<?php if ($this->_var['pager']['search']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#list">上架</a>
                <b class="icon-order-<?php if ($this->_var['pager']['search']['sort'] == 'goods_id'): ?><?php echo $this->_var['pager']['search']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b>
              </dd>
              <dd class=<?php if ($this->_var['pager']['search']['sort'] == 'shop_price'): ?>curr<?php endif; ?>>
              	<a href="search.php?<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item']):
?><?php if ($this->_var['key'] != "sort" && $this->_var['key'] != "order"): ?><?php echo $this->_var['key']; ?>=<?php echo $this->_var['item']; ?>&<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>page=<?php echo $this->_var['pager']['page']; ?>&sort=shop_price&order=<?php if ($this->_var['pager']['search']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#list">价格</a>
                <b class="icon-order-<?php if ($this->_var['pager']['search']['sort'] == 'shop_price'): ?><?php echo $this->_var['pager']['search']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b>
              </dd>
              <dd  class=<?php if ($this->_var['pager']['search']['sort'] == 'last_update'): ?>curr<?php endif; ?>>
              	<a href="search.php?<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item']):
?><?php if ($this->_var['key'] != "sort" && $this->_var['key'] != "order"): ?><?php echo $this->_var['key']; ?>=<?php echo $this->_var['item']; ?>&<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>page=<?php echo $this->_var['pager']['page']; ?>&sort=last_update&order=<?php if ($this->_var['pager']['search']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#list">更新</a>
                <b class="icon-order-<?php if ($this->_var['pager']['search']['sort'] == 'last_update'): ?><?php echo $this->_var['pager']['search']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b>
              </dd>
              <dd  class=<?php if ($this->_var['pager']['search']['sort'] == 'click_count'): ?>curr<?php endif; ?>>
              	<a href="search.php?<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item']):
?><?php if ($this->_var['key'] != "sort" && $this->_var['key'] != "order"): ?><?php echo $this->_var['key']; ?>=<?php echo $this->_var['item']; ?>&<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>page=<?php echo $this->_var['pager']['page']; ?>&sort=click_count&order=<?php if ($this->_var['pager']['search']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#list">人气</a>
                <b class="icon-order-<?php if ($this->_var['pager']['search']['sort'] == 'click_count'): ?><?php echo $this->_var['pager']['search']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b>
              </dd>
            </dl>

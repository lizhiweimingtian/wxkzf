...
?> 
	  ...
	  <?php echo $this->html_options(array('options'=>$this->_var['passwd_questions'])); ?>
            ...
            <?php else: ?>
            <div class="item">
              <input name="extend_field<?php echo $this->_var['field']['id']; ?>" id="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" class="text" placeholder="<?php echo $this->_var['field']['reg_field_name']; ?>" onblur="check_field('extend_field<?php echo $this->_var['field']['id']; ?>','<?php echo $this->_var['field']['reg_field_name']; ?>',this.value)"/>
              ...
              <div><span style="display:none" <?php if ($this->_var['field']['is_need']): ?>id="extend_field<?php echo $this->_var['field']['id']; ?>i"<?php endif; ?>><?php echo $this->_var['field']['reg_field_name']; ?></span><span class="label"id="extend_field<?php echo $this->_var['field']['id']; ?>y"></span></div>
            </div>
	...
	<script>mobile_field='extend_field<?php echo $this->_var['field']['id']; ?>';</script>
     ...
     <div class="item" style="margin-bottom:30px;*margin-bottom:0px">
    ...
    <script type="text/javascript" src="sms/sms.js"></script>
            ...
            <div class="item">
              ...
              <label class="img"> <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" /> </label>
            </div>
            <?php endif; ?>

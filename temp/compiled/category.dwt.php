...
?>
          ...
          <dl style="border-top:none;" id="attr_group_dl_brand">
            ...
            <dd class="moredd">
              ...
              <label> <a href="javascript:void(0)" onclick="showDuoXuan('attr_group_dl_brand', 'brand');" class="duo_ecshop120"><font class="duo_b">+</font>多选</a> </label>
            </dd>
            <dd>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_zimu" style="display:none;"> <span class="span"><a href="javascript:void(0);" onmouseover="getBrand_By_Zimu(this,'')" id="brand_zimu_all">所有品牌</a></span> <?php $_from = $this->_var['brand_zimu_ecshop120']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'bzimu');if (count($_from)):
...
?> 
                  ...
                  <li title="<?php echo $this->_var['brand']['brand_name']; ?>" name="<?php echo $this->_var['brand']['pinyin']; ?>" rel="<?php echo $this->_var['brand']['shouzimu']; ?>" <?php if ($this->_foreach['brands_ecshop120']['iteration'] > 8): ?>class="bottom"<?php endif; ?>>
                    ...
                    <a href="<?php echo $this->_var['brand']['url']; ?>" onclick="return duoxuan_Onclick('brand','<?php echo $this->_foreach['brands_ecshop120']['iteration']; ?>', this);"> <?php if ($this->_var['brand']['brand_logo']): ?><img  src="data/brandlogo/<?php echo $this->_var['brand']['brand_logo']; ?>"><?php else: ?><?php echo $this->_var['brand']['brand_name']; ?><?php endif; ?> </a></li>
                  <?php endif; ?> 
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
                <?php else: ?>
...
?> 
                  ...
                  <li title="<?php echo $this->_var['brand']['brand_name']; ?>" name="<?php echo $this->_var['brand']['pinyin']; ?>" rel="<?php echo $this->_var['brand']['shouzimu']; ?>">
                    <input type="checkbox"  name="checkbox_brand[]" id="chk_brand_<?php echo $this->_foreach['brands_ecshop120']['iteration']; ?>" class="chkbox_ecshop120" value="<?php echo $this->_var['brand']['brand_id_ecshop120']; ?>">
                    <a href="<?php echo $this->_var['brand']['url']; ?>"  onclick="return duoxuan_Onclick('brand','<?php echo $this->_foreach['brands_ecshop120']['iteration']; ?>');"><?php echo $this->_var['brand']['brand_name']; ?></a> </li>
                  <?php endif; ?> 
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
                <?php endif; ?> </div>
...
?> 
	     ...
	     <input type="text" name="price_max" id="price_max" value="<?php echo $this->_var['price_max']; ?>" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
          ...
          <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('kattr', 'filter_attr_0_83234900_1471663971');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['kattr'] => $this->_var['filter_attr_0_83234900_1471663971']):
...
?>
          <dl  name="attr_group_dl" id="attr_group_dl_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>" >
            <dt><?php echo htmlspecialchars($this->_var['filter_attr_0_83234900_1471663971']['filter_attr_name']); ?>：</dt>
            <dd class="moredd">
              <label id="attr_more_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>"></label>
              <label><a href="javascript:void(0)" onclick="showDuoXuan('attr_group_dl_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>', '<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>');" class="duo_ecshop120"><font class="duo_b">+</font>多选</a></label>
            </dd>
            <dd>
              <ul id="attr_abox_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
                <?php $_from = $this->_var['filter_attr_0_83234900_1471663971']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');$this->_foreach['attr_list_ecshop120'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['attr_list_ecshop120']['total'] > 0):
    foreach ($_from AS $this->_var['attr']):
        $this->_foreach['attr_list_ecshop120']['iteration']++;
?> 
                <?php if (($this->_foreach['attr_list_ecshop120']['iteration'] - 1) > 0): ?>
                <li> <?php if ($this->_var['filter_attr_0_83234900_1471663971']['filter_attr_name'] == '颜色'): ?> <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>','<?php echo $this->_foreach['attr_list_ecshop120']['iteration']; ?>', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>[]" id="chk_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>_<?php echo $this->_foreach['attr_list_ecshop120']['iteration']; ?>" value="<?php echo $this->_var['attr']['goods_id']; ?>">
                  <a href="<?php echo $this->_var['attr']['url']; ?>" title="<?php echo $this->_var['attr']['attr_value']; ?>"  onclick="return duoxuan_Onclick('<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>','<?php echo $this->_foreach['attr_list_ecshop120']['iteration']; ?>', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#<?php echo $this->_var['attr']['color_code']; ?>;">&nbsp;</a> </span> <?php else: ?>
                  <input type="checkbox"  name="checkbox_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>[]" id="chk_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>_<?php echo $this->_foreach['attr_list_ecshop120']['iteration']; ?>" class="chkbox_ecshop120" value="<?php echo $this->_var['attr']['goods_id']; ?>" >
                  <a href="<?php echo $this->_var['attr']['url']; ?>" onclick="return duoxuan_Onclick('<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>','<?php echo $this->_foreach['attr_list_ecshop120']['iteration']; ?>');"><?php echo $this->_var['attr']['attr_value']; ?></a> <?php endif; ?> </li>
                <?php endif; ?> 
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </ul>
              <div class="duoxuan_btnbox" >

...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">食品生鲜</a> <code>&gt;</code> <a href="category.php?id=14">进口水果</a>  </div>
</div>
<div class="blank"></div>
  <div class="w main">
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=curr><a href="category.php?category=14&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?category=14&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?category=14&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?category=14&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">更新</a><b class="icon-order-DESCending"></b></dd>
          <dd class=><a href="category.php?category=14&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
     ...
     <script type="text/javascript" src="js/select_region.js?0705"></script>     <div class="leixing">
	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=14&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  >全部	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=14&amp;price_min=0&amp;price_max=0&amp;filter=1"'  >网站自营	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=14&amp;price_min=0&amp;price_max=0&amp;filter=2"'  >入驻商店铺	  	  </div>
     </div>

  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=curr><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">上架</a><b class="icon-order-DESCending"></b></dd>
          ...
          <dd  class=><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格</a><b class="icon-order-DESCending"></b></dd>

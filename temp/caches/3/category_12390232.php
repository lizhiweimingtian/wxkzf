    ...
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          ...
          <dd class=curr><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=click_count&order=ASC#goods_list" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>

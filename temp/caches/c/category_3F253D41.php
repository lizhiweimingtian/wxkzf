...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">服装服饰</a>  </div>
</div>
<div class="blank"></div>
  <div class="w main">
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=shop_price&order=DESC#goods_list">价格</a><b class="icon-order-ASCending"></b></dd>
          <dd  class=><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">更新</a><b class="icon-order-DESCending"></b></dd>
          <dd class=><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter=0&mystock=1&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
     ...
     <script type="text/javascript" src="js/select_region.js?0705"></script>     <div class="leixing">
	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  >全部	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;filter=1"'  >网站自营	  	  <input type='radio' name='fff' onclick='top.location.href="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;filter=2"'  >入驻商店铺	  	  </div>
     </div>
...
//-->
  ...
  <div class="mc" id="cate"> 
        <div class='item  ' >
      <h3 onclick="tab(0)" ><b></b>女装馆</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=65"  >复古旗袍</a></li>
                <li><a href="category.php?id=66"  >牛仔裤</a></li>
                <li><a href="category.php?id=61"  >连衣裙</a></li>
                <li><a href="category.php?id=67"  >短外套</a></li>
                <li><a href="category.php?id=62"  >连体裤</a></li>
                <li><a href="category.php?id=68"  >防晒衫</a></li>
                <li><a href="category.php?id=63"  >棉麻T恤</a></li>
                <li><a href="category.php?id=64"  >时尚套装</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(1)" ><b></b>内衣馆</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=76"  >瘦腿袜</a></li>
                <li><a href="category.php?id=71"  >无钢圈文胸</a></li>
                <li><a href="category.php?id=72"  >女士内裤</a></li>
                <li><a href="category.php?id=73"  >男士内裤</a></li>
                <li><a href="category.php?id=74"  >夏季睡衣</a></li>
                <li><a href="category.php?id=69"  >聚拢文胸</a></li>
                <li><a href="category.php?id=75"  >性感睡衣</a></li>
                <li><a href="category.php?id=70"  >薄款文胸</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(2)" ><b></b>男装馆</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=81"  >针织衫</a></li>
                <li><a href="category.php?id=82"  >长袖衬衫</a></li>
                <li><a href="category.php?id=77"  >休闲裤</a></li>
                <li><a href="category.php?id=83"  >休闲短裤</a></li>
                <li><a href="category.php?id=78"  >牛仔裤</a></li>
                <li><a href="category.php?id=84"  >POLO衫</a></li>
                <li><a href="category.php?id=79"  >夹克</a></li>
                <li><a href="category.php?id=80"  >风衣</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(3)" ><b></b>户外鞋服</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=92"  >登山鞋</a></li>
                <li><a href="category.php?id=87"  >帆布鞋</a></li>
                <li><a href="category.php?id=88"  >羽毛球鞋</a></li>
                <li><a href="category.php?id=89"  >迷彩裤</a></li>
                <li><a href="category.php?id=90"  >沙滩鞋</a></li>
                <li><a href="category.php?id=85"  >跑步鞋</a></li>
                <li><a href="category.php?id=91"  >钓鱼服</a></li>
                <li><a href="category.php?id=86"  >篮球鞋</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(4)" ><b></b>女鞋馆</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=97"  >浅口单鞋</a></li>
                <li><a href="category.php?id=98"  >帆布鞋</a></li>
                <li><a href="category.php?id=93"  >高跟凉拖</a></li>
                <li><a href="category.php?id=99"  >乐福鞋</a></li>
                <li><a href="category.php?id=94"  >平底鞋</a></li>
                <li><a href="category.php?id=100"  >松糕鞋</a></li>
                <li><a href="category.php?id=95"  >高跟鞋</a></li>
                <li><a href="category.php?id=96"  >坡跟单鞋</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(5)" style="border:none"><b></b>箱包馆</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=108"  >拉杆包</a></li>
                <li><a href="category.php?id=103"  >女士钱包</a></li>
                <li><a href="category.php?id=104"  >男士双肩</a></li>
                <li><a href="category.php?id=105"  >男士钱包</a></li>
                <li><a href="category.php?id=106"  >旅行箱</a></li>
                <li><a href="category.php?id=101"  >单肩女包</a></li>
                <li><a href="category.php?id=107"  >拉杆箱</a></li>
                <li><a href="category.php?id=102"  >手提女包</a></li>

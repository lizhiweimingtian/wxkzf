...
if ($_REQUEST['act'] == 'list')
{
	...
	/* 出库类型 */
	$sql = "select type_id, type_name from ". $ecs->table('store_inout_type') ." where in_out=1 and is_valid=1 and supplier_id in (-1,".$_REQUEST[storetypeid].") order by type_id asc";
